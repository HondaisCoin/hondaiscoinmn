...
COIN_NAME='HondaisCoinMN'
coin_name="hondaiscoinmn"
COIN_DATA="hondaiscoinmncore"
COIN_PORT=7820
COIN_RPCPORT=7819
...
COIN_TGZ="https://github.com/hondaiscoinmn-official/hondaiscoinmn/releases/download/v1.0.0.1/hondaiscoinmncore-1.0.0-linux${KERN_ARCH}.tar.gz"
...
function install_sentinel() {
  ...
  local SENTINEL_PATH="sentinel-hondaiscoinmn"
  cd $CONFIGHOME
  git clone https://github.com/hondaiscoinmn-official/sentinel.git $SENTINEL_PATH
  cd $SENTINEL_PATH
