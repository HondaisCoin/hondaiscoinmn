 ...
 *
 *   // network
 *   CHondaisCoinMNNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.hondaiscoinmn.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CHondaisCoinMNNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CHondaisCoinMNNetwork(UniValue objIn)
    {
...
// // can be under: HondaisCoinMNNetwork
// //   -- signature requirements : Key1(User)
// class CHondaisCoinMNNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == HondaisCoinMNNetwork);
//     // }
