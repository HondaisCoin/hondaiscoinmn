...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "HondaisCoinMNNetwork") type = HondaisCoinMNNetwork;
    if(strType == "HondaisCoinMNNetworkVariable") type = HondaisCoinMNNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == HondaisCoinMNNetwork) s = "HondaisCoinMNNetwork";
    if(type == HondaisCoinMNNetworkVariable) s = "HondaisCoinMNNetworkVariable";
