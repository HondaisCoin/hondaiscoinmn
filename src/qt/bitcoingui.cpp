...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About HondaisCoinMN Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for HondaisCoinMN Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the HondaisCoinMN Core help message to get a list with possible HondaisCoinMN Core command-line options"));
...
void BitcoinGUI::message(const QString &title, const QString &message, unsigned int style, bool *ret)
{
    ...
    // Append title to "HondaisCoinMN Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
