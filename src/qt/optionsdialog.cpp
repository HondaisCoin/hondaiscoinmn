    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("HDCMNASH-light"), QVariant("light"));
    ui->theme->addItem(QString("HDCMNASH-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("HDCMNASH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("HDCMNASH-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("HDCMNASH-traditional"), QVariant("trad"));
