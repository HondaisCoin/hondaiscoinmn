...
2. run hondaiscoinmnd with -printalert or -sendalert like this:
   /path/to/hondaiscoinmnd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.hondaiscoinmn.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/HondaisCoinMN Core:0.12.0.58/"));
