...
const char * const BITCOIN_CONF_FILENAME = "hondaiscoinmn.conf";
const char * const BITCOIN_PID_FILENAME = "hondaiscoinmnd.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\HondaisCoinMNCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\HondaisCoinMNCore
    // Mac: ~/Library/Application Support/HondaisCoinMNCore
    // Unix: ~/.hondaiscoinmncore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "HondaisCoinMNCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/HondaisCoinMNCore";
#else
    // Unix
    return pathRet / ".hondaiscoinmncore";
#endif
#endif
}
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty hondaiscoinmn.conf if it does not excist
